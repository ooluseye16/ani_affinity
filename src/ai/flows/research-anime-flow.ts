...
const ResearchAnimeOutputSchema = z.object({
  ...
  imageUrl: z.string().optional().describe('A URL to a relevant image for the anime (e.g., cover art, promotional image). Use a placeholder if no specific image is found.'),
});
