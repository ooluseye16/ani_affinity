 ...
 *
 * - suggestAnime - A function that takes a list of liked anime and suggests new anime with a description, rating, and confidence score.
...
const suggestAnimePrompt = ai.definePrompt({
  ...
  Suggest 3 animes, include a title, description, rating (out of 10) and the likelihood that the user will enjoy them (confidence percentage) using the estimateConfidence tool.
